...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        css = requests.get("https://raw.githubusercontent.com/ColinDuquesnoy/QDarkStyleSheet/master/qdarkstyle/style.qss").text
        ...
        back_btn = QAction(LoadImage("Backward.png"), "Back", self)
        back_btn.setStatusTip("Back")
        back_btn.triggered.connect(lambda: self.tabs.currentWidget().back())
        navtb.addAction(back_btn)

        next_btn = QAction(LoadImage("Forward.png"), "Forward", self)
